...
function lib:Window(text, preset, closebind)
    ...
    MinimizeButton.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    ...
    ExitButton.Position = UDim2.new(1, -32, 0, 10)
    ExitButton.Size = UDim2.new(0, 24, 0, 22)
    ...
    MaximizeButton.Parent = ui
    MaximizeButton.AnchorPoint = Vector2.new(0.5, 0.5)
    MaximizeButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    MaximizeButton.BorderSizePixel = 0
    MaximizeButton.Position = UDim2.new(0.5, 0, 0.5, 0)
    MaximizeButton.Size = UDim2.new(0, 170, 0, 36)
    ...
    MakeDraggable(MaximizeButton, MaximizeButton)

    local windowMinimized = false
    local windowClosed = false

    local function minimizeWindow()
        if windowMinimized or windowClosed then return end

        windowMinimized = true
        MaximizeButton.Position = Main.Position
        ...
        Main:TweenSize(
            ...
            true,
            function()
                if windowMinimized and not windowClosed then
                    Main.Visible = false
    ...
    local function maximizeWindow()
        if not windowMinimized or windowClosed then return end

        windowMinimized = false

        Main.Position = MaximizeButton.Position
        Main.Size = UDim2.new(0, 0, 0, 0)
        Main.Visible = true
        MaximizeButton.Visible = false
    ...
    ExitButton.MouseButton1Click:Connect(exitWindow)
    ...
    UserInputService.InputBegan:Connect(
        function(io, p)
            ...
            if io.KeyCode == CloseBind then
                if windowClosed then return end
